...
|2|p.63|図2-17で示す図形は長方形でp.72図2-15のような台形ではないのに、これで面積になるのはなぜか|二つの図形の違いは、上部の三角形の部分です。横幅を無限に0に近づけると、長方形の面積は<img src='./images/faq-05-1.png'/>ですが、三角形の面積は<img src='./images/faq-05-2.png'/>となります。(p.72参照)。<br>長方形の面積と比べると無視できる大きさなので(両者をdxで割ってみるとわかります)、三角形の部分は考慮に入れなくていいのです。|2019-11-25|
